...
namespace array2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int i = 0, h = 0, intsum = 0, intmedian = 0;//the variables that will be called in the program
            decimal decmedian = 0;
            ...
            intsum = intvalue[4] + intvalue[5];//I did the median intentionally after the array had been sorted so that the output would show the true median of the numbers that were entered
            decmedian = intsum / 2;//making the average of the median
            Console.Write("This is the median of all the numbers you responded with is " + Math.Round(decmedian));//rounding the numbers
